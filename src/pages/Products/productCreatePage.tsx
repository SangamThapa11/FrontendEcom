...
const ProductCreatePage = () => {
    ...
    const submitForm = async (data: IProductDataType) => {
        try {
            ...
            // Handle category array - format as comma-separated string
            if (data.category && data.category.length > 0) {
                ...
                formData.append('category[]', ''); // or null based on backend expectation
            }
            ...
            formData.append('brand', data.brand || ''); // Handle null case
            formData.append('description', data.description);
            formData.append('price', String(data.price));
            formData.append('discount', String(data.discount || 0)); // Default to 0 if null
            ...
            toast.error("Sorry!", {
                description: exception.message ||
                    "Product could not be created at this moment. Please try again later.",
            });
        }
    };
    return (
        <div className="flex flex-col h-screen overflow-y-auto overflow-hidden">
            ...
            <div className="flex-shrink-0">
                <ListPageHeader pageTitle="Create Product" />
            </div>
